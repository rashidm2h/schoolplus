    ...
    AsyncStorage.getItem('acess_token').then(
      keyValue => {
        AsyncStorage.getItem('StdID').then(
          keyValue2 => {
            console.log(`<soap12:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://www.w3.org/2003/05/soap-envelope">
 <soap12:Body>
