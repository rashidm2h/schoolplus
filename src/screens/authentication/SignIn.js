  ...
  const SignUPUserChecking = async () => {
    ...
    try {
      const response = await fetch(
        `${GLOBALS.PARENT_SERVICE}SignUPUserChecking`,
        {
          method: 'POST',
      ...
      const signupresult = xmlDoc.getElementsByTagName(
        'SignUPUserCheckingResult',
      ...
      if (signupresult === 'Phone Number not Register') {
        ...
        signupresult === "Teacher Doesn't Exists or Not Approved by Admin"
      ) {
